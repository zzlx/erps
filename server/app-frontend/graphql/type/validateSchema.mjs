...
import { isRequiredArgument } from './isRequiredArgument.mjs';
...
function validateRootTypes(context) {
  ...
  if (!queryType) {
    ...
    context.reportError(
      "Query root type must be Object type, it cannot be ".concat(inspect(queryType), "."), 
  ...
  if (subscriptionType && !isObjectType(subscriptionType)) {
    context.reportError(
      ...
      "".concat(inspect(subscriptionType), "."), 
...
function validateName(context, node) {
  ...
  if (error) { context.addError(error); }
}
...
function validateTypes(context) {
  ...
  try {
    for (
      let _iterator4 = Object.values(typeMap)[Symbol.iterator](), _step4; 
...
function validateFields(context, type) {
  ...
  try {
    for (
      var _iterator5 = fields[Symbol.iterator](), _step5; 
...
function validateObjectImplementsInterface(context, object, iface) {
  ...
  try {
    for (var _iterator8 = Object.entries(ifaceFieldMap)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      ...
      try {
        var _loop = function _loop() {
          ...
          var objectArg = Array.prototype.find.call(objectField.args, function (arg) {
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          var ifaceArg = Array.prototype.find.call(ifaceField.args, function (arg) {
            return arg.name === argName;
          });
...
function getFieldNode(type, fieldName) {
  return Array.prototype.find.call(getAllSubNodes(type, function (typeNode) {
