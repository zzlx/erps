...
export default function createStore(reducer, preloadedState, enhancer) {
  if (
    ...
    throw new Error(
      'It looks like you are passing several store enhancers,' +
   ...
   * you need to wrap store creating function into the corresponding middleware. 
   * For example, see the documentation for the `redux-thunk` package. Even the
  ...
  function observable() {
    ...
    }, _ref[$$observable] = function () { return this; }, _ref;
  }
